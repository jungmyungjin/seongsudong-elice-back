...
exports.createCommentsTable = void 0;
const fs_1 = __importDefault(require("fs"));
const index_1 = require("../db/index");
const sqlFilePath = './src/db/comment.sql'; // SQL 파일의 경로
const commentsTableSchema = fs_1.default.readFileSync(sqlFilePath, 'utf-8');
const createCommentsTable = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield (0, index_1.executeQuery)(commentsTableSchema);
